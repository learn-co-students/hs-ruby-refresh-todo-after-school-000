...
2. Goats have the following attributes: age, name, pokes (an integer that defaults to zero on initialization), milk_in_udders (a float that defaults to 1 on initialization), moody (a true/false boolean that defaults to false upon initialization).
